...
static GtkActionEntry entries[] =
{
    ...
    { "open-torrent-from-url-toolbar", GTK_STOCK_OPEN, N_("Open URL..."), NULL, N_("Open URL..."), G_CALLBACK(action_cb) },
    { "open-torrent-from-url-menu", GTK_STOCK_OPEN, N_("Open _URL…"), "<control>U", N_("Open URL…"), G_CALLBACK(action_cb) },
