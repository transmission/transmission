...
#include "tr/torrent/net.h" // tr_diffserv_t, tr_port
#include "tr/torrent/open-files.h" // tr_open_files::Preallocation
#include "tr/torrent/peer-io.h" // tr_preferred_transport
#include "tr/torrent/types.h" // tr_encryption_mode, tr_verify_added_mode, tr_mode_t
