...
#include "lib/transmission/net.h" // tr_diffserv_t, tr_port
#include "lib/transmission/open-files.h" // tr_open_files::Preallocation
#include "lib/transmission/peer-io.h" // tr_preferred_transport
#include "lib/transmission/types.h" // tr_encryption_mode, tr_verify_added_mode, tr_mode_t
