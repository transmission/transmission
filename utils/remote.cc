...
auto constexpr Options = std::array<tr_option, 105>{ {
    { 'a', "add", "Add torrent files by filename or URL", "a", tr_option::Arg::None, nullptr },
    { 970, "alt-speed", "Use the alternate Limits", "as", tr_option::Arg::None, nullptr },
    { 971, "no-alt-speed", "Don't use the alternate Limits", "AS", tr_option::Arg::None, nullptr },
    { 972,
      "alt-speed-downlimit",
      "max alternate download speed (in " SPEED_K_STR ")",
      "asd",
      tr_option::Arg::Required,
      "<speed>" },
    { 973, "alt-speed-uplimit", "max alternate upload speed (in " SPEED_K_STR ")", "asu", tr_option::Arg::Required, "<speed>" },
    { 974, "alt-speed-scheduler", "Use the scheduled on/off times", "asc", tr_option::Arg::None, nullptr },
    { 975, "no-alt-speed-scheduler", "Don't use the scheduled on/off times", "ASC", tr_option::Arg::None, nullptr },
    { 976,
    ...
    { 978,
      "alt-speed-days",
      "Numbers for any/all days of the week - eg. \"1-7\"",
      nullptr,
      tr_option::Arg::Required,
      "<days>" },
    { 963, "blocklist-update", "Blocklist update", nullptr, tr_option::Arg::None, nullptr },
    { 'c', "incomplete-dir", "Where to store new torrents until they're complete", "c", tr_option::Arg::Required, "<dir>" },
    { 'C', "no-incomplete-dir", "Don't store incomplete torrents in a different location", "C", tr_option::Arg::None, nullptr },
    { 'b', "debug", "Print debugging information", "b", tr_option::Arg::None, nullptr },
    { 730, "bandwidth-group", "Set the current torrents' bandwidth group", "bwg", tr_option::Arg::Required, "<group>" },
    { 731, "no-bandwidth-group", "Reset the current torrents' bandwidth group", "nwg", tr_option::Arg::None, nullptr },
    { 732, "list-groups", "Show bandwidth groups with their parameters", "lg", tr_option::Arg::None, nullptr },
    { 'd',
      "downlimit",
    ...
    { 'D',
      "no-downlimit",
      "Disable max download speed for the current torrent(s) or globally",
      "D",
      tr_option::Arg::None,
      nullptr },
    { 'e',
      "cache",
      "Set the maximum size of the session's memory cache (in " MEM_M_STR ")",
      "e",
      tr_option::Arg::Required,
      "<size>" },
    ...
    { 850, "exit", "Tell the transmission session to shut down", nullptr, tr_option::Arg::None, nullptr },
    { 940, "files", "List the current torrent(s)' files", "f", tr_option::Arg::None, nullptr },
    { 'F', "filter", "Filter the current torrent(s)", "F", tr_option::Arg::Required, "criterion" },
    { 'g', "get", "Mark files for download", "g", tr_option::Arg::Required, "<files>" },
    { 'G', "no-get", "Mark files for not downloading", "G", tr_option::Arg::Required, "<files>" },
    { 'i', "info", "Show the current torrent(s)' details", "i", tr_option::Arg::None, nullptr },
    { 944, "print-ids", "Print the current torrent(s)' ids", "ids", tr_option::Arg::None, nullptr },
    { 940, "info-files", "List the current torrent(s)' files", "if", tr_option::Arg::None, nullptr },
    { 941, "info-peers", "List the current torrent(s)' peers", "ip", tr_option::Arg::None, nullptr },
    { 942, "info-pieces", "List the current torrent(s)' pieces", "ic", tr_option::Arg::None, nullptr },
    { 943, "info-trackers", "List the current torrent(s)' trackers", "it", tr_option::Arg::None, nullptr },
    { 'j', "json", "Return RPC response as a JSON string", "j", tr_option::Arg::None, nullptr },
    { 920, "session-info", "Show the session's details", "si", tr_option::Arg::None, nullptr },
    { 921, "session-stats", "Show the session's statistics", "st", tr_option::Arg::None, nullptr },
    { 'l', "list", "List all torrents", "l", tr_option::Arg::None, nullptr },
    { 'L', "labels", "Set the current torrents' labels", "L", tr_option::Arg::Required, "<label[,label...]>" },
    { 960, "move", "Move current torrent's data to a new folder", nullptr, tr_option::Arg::Required, "<path>" },
    { 968, "unix-socket", "Use a Unix domain socket", nullptr, tr_option::Arg::Required, "<path>" },
    { 961, "find", "Tell Transmission where to find a torrent's data", nullptr, tr_option::Arg::Required, "<path>" },
    { 964, "rename", "Rename torrents root folder or a file", nullptr, tr_option::Arg::Required, "<name>" },
    { 965, "path", "Provide path for rename functions", nullptr, tr_option::Arg::Required, "<path>" },
    ...
    { 'n', "auth", "Set username and password", "n", tr_option::Arg::Required, "<user:pw>" },
    { 810,
      "authenv",
      "Set authentication info from the TR_AUTH environment variable (user:pw)",
      "ne",
      tr_option::Arg::None,
      nullptr },
    { 'N', "netrc", "Set authentication info from a .netrc file", "N", tr_option::Arg::Required, "<file>" },
    { 820, "ssl", "Use SSL when talking to daemon", nullptr, tr_option::Arg::None, nullptr },
    { 'o', "dht", "Enable distributed hash tables (DHT)", "o", tr_option::Arg::None, nullptr },
    { 'O', "no-dht", "Disable distributed hash tables (DHT)", "O", tr_option::Arg::None, nullptr },
    { 'p', "port", "Port for incoming peers (Default: " TR_DEFAULT_PEER_PORT_STR ")", "p", tr_option::Arg::Required, "<port>" },
    { 962, "port-test", "Port testing", "pt", tr_option::Arg::None, nullptr },
    { 'P', "random-port", "Random port for incoming peers", "P", tr_option::Arg::None, nullptr },
    { 900, "priority-high", "Try to download these file(s) first", "ph", tr_option::Arg::Required, "<files>" },
    { 901, "priority-normal", "Try to download these file(s) normally", "pn", tr_option::Arg::Required, "<files>" },
    { 902, "priority-low", "Try to download these file(s) last", "pl", tr_option::Arg::Required, "<files>" },
    { 700, "bandwidth-high", "Give this torrent first chance at available bandwidth", "Bh", tr_option::Arg::None, nullptr },
    { 701,
      "bandwidth-normal",
      "Give this torrent bandwidth left over by high priority torrents",
      "Bn",
      tr_option::Arg::None,
      nullptr },
    { 702,
      ...
      tr_option::Arg::None,
      nullptr },
    { 600, "reannounce", "Reannounce the current torrent(s)", nullptr, tr_option::Arg::None, nullptr },
    { 'r', "remove", "Remove the current torrent(s)", "r", tr_option::Arg::None, nullptr },
    { 930,
      "peers",
      "Set the maximum number of peers for the current torrent(s) or globally",
      "pr",
      tr_option::Arg::Required,
      "<max>" },
    { 840, "remove-and-delete", "Remove the current torrent(s) and delete local data", "rad", tr_option::Arg::None, nullptr },
    { 800,
      "torrent-done-script",
      "A script to run when a torrent finishes downloading",
      nullptr,
      tr_option::Arg::Required,
      "<file>" },
    { 801, "no-torrent-done-script", "Don't run the done-downloading script", nullptr, tr_option::Arg::None, nullptr },
    { 802,
      "torrent-done-seeding-script",
      "A script to run when a torrent finishes seeding",
      nullptr,
      tr_option::Arg::Required,
      "<file>" },
    { 803, "no-torrent-done-seeding-script", "Don't run the done-seeding script", nullptr, tr_option::Arg::None, nullptr },
    { 950, "seedratio", "Let the current torrent(s) seed until a specific ratio", "sr", tr_option::Arg::Required, "ratio" },
    { 951,
      "seedratio-default",
      ...
      tr_option::Arg::None,
      nullptr },
    { 952, "no-seedratio", "Let the current torrent(s) seed regardless of ratio", "SR", tr_option::Arg::None, nullptr },
    { 953,
      "global-seedratio",
    ...
    { 956,
      ...
      nullptr },
    { 957,
      "no-idle-seeding-limit",
      "Let the current torrent(s) seed regardless of idle time",
      "ISL",
      tr_option::Arg::None,
      nullptr },
    { 958,
    ...
    { 959,
      ...
      tr_option::Arg::None,
      nullptr },
    { 710, "tracker-add", "Add a tracker to a torrent", "td", tr_option::Arg::Required, "<tracker>" },
    { 712, "tracker-remove", "Remove a tracker from a torrent", "tr", tr_option::Arg::Required, "<trackerId>" },
    { 's', "start", "Start the current torrent(s)", "s", tr_option::Arg::None, nullptr },
    { 'S', "stop", "Stop the current torrent(s)", "S", tr_option::Arg::None, nullptr },
    { 't', "torrent", "Set the current torrent(s)", "t", tr_option::Arg::Required, "<torrent>" },
    { 990, "start-paused", "Start added torrents paused", nullptr, tr_option::Arg::None, nullptr },
    { 991, "no-start-paused", "Start added torrents unpaused", nullptr, tr_option::Arg::None, nullptr },
    { 992, "trash-torrent", "Delete torrents after adding", nullptr, tr_option::Arg::None, nullptr },
    { 993, "no-trash-torrent", "Do not delete torrents after adding", nullptr, tr_option::Arg::None, nullptr },
    { 994, "sequential-download", "Download the torrent sequentially", "seq", tr_option::Arg::None, nullptr },
    { 995, "no-sequential-download", "Download the torrent sequentially", "SEQ", tr_option::Arg::None, nullptr },
    { 984, "honor-session", "Make the current torrent(s) honor the session limits", "hl", tr_option::Arg::None, nullptr },
    { 985,
      "no-honor-session",
    ...
    { 'U',
      "no-uplimit",
      "Disable max upload speed for the current torrent(s) or globally",
      "U",
      tr_option::Arg::None,
      nullptr },
    { 830, "utp", "Enable µTP for peer connections", nullptr, tr_option::Arg::None, nullptr },
    { 831, "no-utp", "Disable µTP for peer connections", nullptr, tr_option::Arg::None, nullptr },
    { 'v', "verify", "Verify the current torrent(s)", "v", tr_option::Arg::None, nullptr },
    ...
    { 'w',
      ...
      tr_option::Arg::Required,
      "<path>" },
    { 'x', "pex", "Enable peer exchange (PEX)", "x", tr_option::Arg::None, nullptr },
    { 'X', "no-pex", "Disable peer exchange (PEX)", "X", tr_option::Arg::None, nullptr },
    { 'y', "lpd", "Enable local peer discovery (LPD)", "y", tr_option::Arg::None, nullptr },
    { 'Y', "no-lpd", "Disable local peer discovery (LPD)", "Y", tr_option::Arg::None, nullptr },
    { 941, "peer-info", "List the current torrent(s)' peers", "pi", tr_option::Arg::None, nullptr },
