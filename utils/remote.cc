...
auto constexpr Options = std::array<tr_option, 104>{
    { { 'a', "add", "Add torrent files by filename or URL", "a", false, nullptr },
      ...
      { 830,
        ...
        true,
        "<protocol(s)>" },
      { 831, "utp", "DEPRECATED Enable µTP for peer connections", nullptr, false, nullptr },
      { 832, "no-utp", "DEPRECATED Disable µTP for peer connections", nullptr, false, nullptr },
