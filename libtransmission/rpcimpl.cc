...
[[nodiscard]] auto make_peer_vec(tr_torrent const& tor)
{
    ...
    for (auto const& peer : peers)
    {
        ...
        peer_map.try_emplace(TR_KEY_rate_to_client, Speed{ peer.rate_to_client_KBps, Speed::Units::KByps }.base_quantity());
        peer_map.try_emplace(TR_KEY_rate_to_peer, Speed{ peer.rate_to_peer_KBps, Speed::Units::KByps }.base_quantity());
