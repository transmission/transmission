 ...
 */
auto inline constexpr MultiscrapeMax = 60;

auto inline constexpr AnnounceTimeoutSec = std::chrono::seconds{ 45 };
auto inline constexpr ScrapeTimeoutSec = std::chrono::seconds{ 30 };
...
struct tr_scrape_request
{
    ...
    std::array<tr_sha1_digest_t, MultiscrapeMax> info_hash;
...
struct tr_scrape_response
{
    ...
    std::array<tr_scrape_response_row, MultiscrapeMax> rows;
