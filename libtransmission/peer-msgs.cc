    ...
    case BtPeerMsgs::Port:
        ...
        // port of the DHT node in network byte order.
        {
            ...
            if (auto const dht_port = tr_port::fromNetwork(nport); !std::empty(dht_port))
            {
                ...
                msgs->session->dht_add_node(&msgs->io->address(), msgs->dht_port, false);
            }
        }
        break;
