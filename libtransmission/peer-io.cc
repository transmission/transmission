...
void tr_peerIo::setCallbacks(CanRead can_read, DidWrite did_write, GotError got_error, void* user_data)
{
    can_read_ = can_read;
...
bool tr_peerIo::reconnect()
{
    ...
    socket_ = tr_netOpenPeerSocket(session_, addr, port, isSeed());
