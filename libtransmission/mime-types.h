...
inline auto constexpr MimeTypeSuffixes = std::array<mime_type_suffix, 1239>{
    { { R"(123)", R"(application/vnd.lotus-1-2-3)" },
      ...
      { R"(deb)", R"(application/octet-stream)" },
      { R"(def)", R"(text/plain)" },
      ...
      { R"(dll)", R"(application/octet-stream)" },
      { R"(dmg)", R"(application/octet-stream)" },
      ...
      { R"(exe)", R"(application/octet-stream)" },
      ...
      { R"(iso)", R"(application/octet-stream)" },
      ...
      { R"(msh)", R"(model/mesh)" },
      { R"(msi)", R"(application/octet-stream)" },
