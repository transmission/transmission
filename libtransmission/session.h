...
struct CompareStringCaseInsensitive
{
...
public:
    ...
    std::map<uint8_t const*, tr_torrent*, CompareShaDigest> torrentsByHash;
    std::map<char const*, tr_torrent*, CompareStringCaseInsensitive> torrentsByHashString;
