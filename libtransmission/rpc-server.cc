...
#define logerr(msg) \
    ...
    { \
        ...
        { \
            tr_log::error::add(TR_LOC, msg, MyName); \
        } \
    } while (0)
...
#define logwarn(msg) \
    ...
    { \
        ...
        { \
            tr_log::warn::add(TR_LOC, msg, MyName); \
        } \
    } while (0)
...
#define loginfo(msg) \
    ...
    { \
        ...
        { \
            tr_log::info::add(TR_LOC, msg, MyName); \
        } \
    } while (0)
    ...
    , session{ session_in }
{
    ...
    if (this->isEnabled)
    {
        ...
        {
            loginfo(_("Whitelist enabled"));
        }

        if (this->isPasswordEnabled)
        {
            loginfo(_("Password required"));
        }
    }
