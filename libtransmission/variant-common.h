...
void tr_variantWalk(tr_variant const* top, struct VariantWalkFuncs const* walkFuncs,
...
int tr_jsonParse(char const* source, void const* vbuf, size_t len, tr_variant* setme_benc,
                 char const** setme_end);

/** @brief Private function that's exposed here only for unit tests */
int tr_bencParseInt(void const* buf, void const* bufend, uint8_t const** setme_end,
                    int64_t* setme_val);

/** @brief Private function that's exposed here only for unit tests */
int tr_bencParseStr(void const* buf, void const* bufend, uint8_t const** setme_end,
