...
#define APICOMPAT_KEYS(X) \
    ...
    X(TR_KEY_show_active_kebab, "show-active") \
    X(TR_KEY_show_all_kebab, "show-all") \
    X(TR_KEY_show_backup_trackers_kebab, "show-backup-trackers") /* gtk app, qt app */ \
    X(TR_KEY_show_downloading_kebab, "show-downloading") \
    X(TR_KEY_show_error_kebab, "show-error") \
    ...
    X(TR_KEY_show_finished_kebab, "show-finished") \
    ...
    X(TR_KEY_show_paused_kebab, "show-paused") \
    X(TR_KEY_show_seeding_kebab, "show-seeding") \
    ...
    X(TR_KEY_show_verifying_kebab, "show-verifying") \
    ...
    X(TR_KEY_sort_by_activity_kebab, "sort-by-activity") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_age_kebab, "sort-by-age") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_eta_kebab, "sort-by-eta") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_id_kebab, "sort-by-id") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_name_kebab, "sort-by-name") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_progress_kebab, "sort-by-progress") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_queue_kebab, "sort-by-queue") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_ratio_kebab, "sort-by-ratio") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_size_kebab, "sort-by-size") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_state_kebab, "sort-by-state") /* gtk app, qt app */ \
...
auto constexpr SessionKeys = std::array<ApiKey, 157U>{ {
    ...
    { TR_KEY_show_active, TR_KEY_show_active_kebab },
    { TR_KEY_show_all, TR_KEY_show_all_kebab },
    { TR_KEY_show_backup_trackers, TR_KEY_show_backup_trackers_kebab },
    { TR_KEY_show_downloading, TR_KEY_show_downloading_kebab },
    { TR_KEY_show_error, TR_KEY_show_error_kebab },
    { TR_KEY_show_extra_peer_details, TR_KEY_show_extra_peer_details_kebab },
    { TR_KEY_show_filterbar, TR_KEY_show_filterbar_kebab },
    { TR_KEY_show_finished, TR_KEY_show_finished_kebab },
    ...
    { TR_KEY_show_paused, TR_KEY_show_paused_kebab },
    { TR_KEY_show_seeding, TR_KEY_show_seeding_kebab },
    ...
    { TR_KEY_show_verifying, TR_KEY_show_verifying_kebab },
    { TR_KEY_sleep_per_seconds_during_verify, TR_KEY_sleep_per_seconds_during_verify_kebab },
    { TR_KEY_sort_by_activity, TR_KEY_sort_by_activity_kebab },
    { TR_KEY_sort_by_age, TR_KEY_sort_by_age_kebab },
    { TR_KEY_sort_by_eta, TR_KEY_sort_by_eta_kebab },
    { TR_KEY_sort_by_id, TR_KEY_sort_by_id_kebab },
    { TR_KEY_sort_by_name, TR_KEY_sort_by_name_kebab },
    { TR_KEY_sort_by_progress, TR_KEY_sort_by_progress_kebab },
    { TR_KEY_sort_by_queue, TR_KEY_sort_by_queue_kebab },
    { TR_KEY_sort_by_ratio, TR_KEY_sort_by_ratio_kebab },
    { TR_KEY_sort_by_size, TR_KEY_sort_by_size_kebab },
    { TR_KEY_sort_by_state, TR_KEY_sort_by_state_kebab },
