...
void tr_verify_worker::verify_torrent(Mediator& verify_mediator, std::atomic<bool> const& abort_flag, bool limit_io)
{
    ...
    std::function<void(tr_file_index_t, bool, std::string_view)> file_status_cb)
{
    ...
    tr_verify_worker::verify_torrent(mediator, abort_flag, false);
