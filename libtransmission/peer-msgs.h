...
bool tr_peerMsgsIsActive(const tr_peerMsgs* msgs, tr_direction direction);
...
size_t tr_generateAllowedSet(tr_piece_index_t* setmePieces, size_t desiredSetSize, size_t pieceCount, const uint8_t* infohash,
