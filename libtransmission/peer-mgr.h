...
void tr_peerMgrSetUtpSupported(tr_torrent* tor, tr_address const& addr, tr_port port);

void tr_peerMgrSetUtpFailed(tr_torrent* tor, tr_address const& addr, tr_port port, bool failed);
