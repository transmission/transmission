...
#define KNOWN_KEYS(X) \
    ...
    X(TR_KEY_show_active_kebab_APICOMPAT, "show-active") \
    X(TR_KEY_show_all_kebab_APICOMPAT, "show-all") \
    X(TR_KEY_show_backup_trackers_kebab_APICOMPAT, "show-backup-trackers") /* gtk app, qt app */ \
    X(TR_KEY_show_downloading_kebab_APICOMPAT, "show-downloading") \
    X(TR_KEY_show_error_kebab_APICOMPAT, "show-error") \
    ...
    X(TR_KEY_show_finished_kebab_APICOMPAT, "show-finished") \
    ...
    X(TR_KEY_show_paused_kebab_APICOMPAT, "show-paused") \
    X(TR_KEY_show_seeding_kebab_APICOMPAT, "show-seeding") \
    ...
    X(TR_KEY_show_verifying_kebab_APICOMPAT, "show-verifying") \
    X(TR_KEY_show_active, "show_active") \
    X(TR_KEY_show_all, "show_all") \
    X(TR_KEY_show_backup_trackers, "show_backup_trackers") /* gtk app, qt app */ \
    X(TR_KEY_show_downloading, "show_downloading") \
    X(TR_KEY_show_error, "show_error") \
    X(TR_KEY_show_extra_peer_details, "show_extra_peer_details") /* gtk app */ \
    X(TR_KEY_show_filterbar, "show_filterbar") /* gtk app, qt app */ \
    X(TR_KEY_show_finished, "show_finished") \
    ...
    X(TR_KEY_show_paused, "show_paused") \
    X(TR_KEY_show_seeding, "show_seeding") \
    ...
    X(TR_KEY_show_verifying, "show_verifying") \
    ...
    X(TR_KEY_sort_by_activity_kebab_APICOMPAT, "sort-by-activity") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_age_kebab_APICOMPAT, "sort-by-age") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_eta_kebab_APICOMPAT, "sort-by-eta") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_id_kebab_APICOMPAT, "sort-by-id") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_name_kebab_APICOMPAT, "sort-by-name") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_progress_kebab_APICOMPAT, "sort-by-progress") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_queue_kebab_APICOMPAT, "sort-by-queue") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_ratio_kebab_APICOMPAT, "sort-by-ratio") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_size_kebab_APICOMPAT, "sort-by-size") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_state_kebab_APICOMPAT, "sort-by-state") /* gtk app, qt app */ \
    ...
    X(TR_KEY_sort_by_activity, "sort_by_activity") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_age, "sort_by_age") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_eta, "sort_by_eta") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_id, "sort_by_id") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_name, "sort_by_name") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_progress, "sort_by_progress") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_queue, "sort_by_queue") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_ratio, "sort_by_ratio") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_size, "sort_by_size") /* gtk app, qt app */ \
    X(TR_KEY_sort_by_state, "sort_by_state") /* gtk app, qt app */ \
