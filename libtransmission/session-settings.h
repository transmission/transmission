...
#define SESSION_SETTINGS_FIELDS(V) \
    ...
    V(TR_KEY_partial_hash_check_enabled, partial_hash_check_enabled, bool, false, "Globally enable partial hash verification (for seeding homebrew and reposted torrents)") \
    V(TR_KEY_partial_hash_check_ratio, partial_hash_check_ratio, size_t, 256, "The default sampling ratio is 1/256") \
    V(TR_KEY_partial_hash_check_recheck, partial_hash_check_recheck, bool, true, "Recheck all pieces when there is a hash mismatch for the pieces") \
