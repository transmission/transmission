...
cp -R build/Release\ -\ Debug/Transmission.app ./beta/Transmission/
echo CREATING DMG
#create a BZ2 Compressed DMG
hdiutil create -srcfolder beta/Transmission/ -format UDBZ -noanyowners -fs HFS+ beta/Transmission-b.dmg
