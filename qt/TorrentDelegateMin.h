...
protected:
    // TorrentDelegate
    QSize size_hint(QStyleOptionViewItem const& option, Torrent const& tor) const override;
    void draw_torrent(QPainter* painter, QStyleOptionViewItem const& option, Torrent const& tor) const override;
};
