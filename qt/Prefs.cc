...
tr_variant Prefs::get_default_app_settings()
{
    ...
    auto constexpr SortMode = std::string_view{ "sort-by-name" }; // FIXME(ckerr): snake_case
    auto constexpr StatsMode = std::string_view{ "total-ratio" }; // FIXME(ckerr): snake_case
