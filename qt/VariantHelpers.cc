...
#define HANDLE_KEY(key, field) \
    case TR_KEY_##key: \
        ...
        break;
            ...
            HANDLE_KEY(announce_state, announce_state)
            HANDLE_KEY(download_count, download_count)
            HANDLE_KEY(has_announced, has_announced)
            HANDLE_KEY(has_scraped, has_scraped)
            HANDLE_KEY(id, id)
            HANDLE_KEY(is_backup, is_backup)
            HANDLE_KEY(last_announce_peer_count, last_announce_peer_count)
            HANDLE_KEY(last_announce_result, last_announce_result)
            HANDLE_KEY(last_announce_start_time, last_announce_start_time)
            HANDLE_KEY(last_announce_succeeded, last_announce_succeeded)
            HANDLE_KEY(last_announce_time, last_announce_time)
            HANDLE_KEY(last_announce_timed_out, last_announce_timed_out)
            HANDLE_KEY(last_scrape_result, last_scrape_result)
            HANDLE_KEY(last_scrape_start_time, last_scrape_start_time)
            HANDLE_KEY(last_scrape_succeeded, last_scrape_succeeded)
            HANDLE_KEY(last_scrape_time, last_scrape_time)
            HANDLE_KEY(last_scrape_timed_out, last_scrape_timed_out)
            HANDLE_KEY(leecher_count, leecher_count)
            HANDLE_KEY(next_announce_time, next_announce_time)
            HANDLE_KEY(next_scrape_time, next_scrape_time)
            HANDLE_KEY(scrape_state, scrape_state)
            HANDLE_KEY(seeder_count, seeder_count)
