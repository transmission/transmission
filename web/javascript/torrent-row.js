...
class TorrentRendererHelper {
  ...
  static formatUL = (t) => `▲${Transmission.fmt.speedBps(t.getUploadSpeed())}`;
  static formatDL = (t) => `▼${Transmission.fmt.speedBps(t.getDownloadSpeed())}`;
