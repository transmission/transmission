...
class Inspector {
  ...
  static getAnnounceState(tracker) {
    switch (tracker.announceState) {
      ...
      case Torrent._TrackerWaiting: {
        ...
        return `Next announce in ${Transmission.fmt.timeInterval(timeUntilAnnounce)}`;
      }
  ...
  static createFileTreeModel = function (tor) {
    const leaves = [];
    const tree = {
      children: {},
      file_indices: [],
  ...
  updateInspector() {
    ...
    setTextContent(elements.name_lb, name || 'Not Applicable');
