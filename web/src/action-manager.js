...
export class ActionManager extends EventTarget {
  constructor() {
    ...
    this.actions = Object.seal({
      ...
      'move-bottom': { enabled: false, text: 'Move to Bottom' },
      'move-down': { enabled: false, text: 'Move Down' },
      'move-top': { enabled: false, text: 'Move to Top' },
      'move-up': { enabled: false, text: 'Move Up' },
      'open-torrent': {
        enabled: true,
        shortcut: 'O',
        text: 'Open torrent…',
