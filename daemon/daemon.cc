...
auto constexpr Options = std::array<tr_option, 47>{ {
    { 'a',
      "allowed",
      "Allowed IP addresses. (Default: " TR_DEFAULT_RPC_WHITELIST ")",
      "a",
    ...
    { 'c', "watch-dir", "Where to watch for new torrent files", "c", tr_option::Arg::Required, "<directory>" },
    { 'C', "no-watch-dir", "Disable the watch-dir", "C", tr_option::Arg::None, nullptr },
    { 941,
      "incomplete-dir",
    ...
    { 942,
      ...
      tr_option::Arg::None,
      nullptr },
    { 'd', "dump-settings", "Dump the settings and exit", "d", tr_option::Arg::None, nullptr },
    { 943,
      "default-trackers",
      "Trackers for public torrents to use automatically",
      nullptr,
      tr_option::Arg::Required,
      "<list>" },
    { 'e', "logfile", "Dump the log messages to this filename", "e", tr_option::Arg::Required, "<filename>" },
    { 'f', "foreground", "Run in the foreground instead of daemonizing", "f", tr_option::Arg::None, nullptr },
    { 'g', "config-dir", "Where to look for configuration files", "g", tr_option::Arg::Required, "<path>" },
    { 'p', "port", "RPC port (Default: " TR_DEFAULT_RPC_PORT_STR ")", "p", tr_option::Arg::Required, "<port>" },
    { 't', "auth", "Require authentication", "t", tr_option::Arg::None, nullptr },
    { 'T', "no-auth", "Don't require authentication", "T", tr_option::Arg::None, nullptr },
    { 'u', "username", "Set username for authentication", "u", tr_option::Arg::Required, "<username>" },
    { 'v', "password", "Set password for authentication", "v", tr_option::Arg::Required, "<password>" },
    ...
    { 810,
      ...
      tr_option::Arg::Required,
      "<level>" },
    { 811, "log-error", "Deprecated. Use --log-level=error", nullptr, tr_option::Arg::None, nullptr },
    { 812, "log-info", "Deprecated. Use --log-level=info", nullptr, tr_option::Arg::None, nullptr },
    { 813, "log-debug", "Deprecated. Use --log-level=debug", nullptr, tr_option::Arg::None, nullptr },
    { 'w', "download-dir", "Where to save downloaded data", "w", tr_option::Arg::Required, "<path>" },
    { 800, "paused", "Pause all torrents on startup", nullptr, tr_option::Arg::None, nullptr },
    ...
    { 'i', "bind-address-ipv4", "Where to listen for peer connections", "i", tr_option::Arg::Required, "<ipv4 addr>" },
    { 'I', "bind-address-ipv6", "Where to listen for peer connections", "I", tr_option::Arg::Required, "<ipv6 addr>" },
    { 'r', "rpc-bind-address", "Where to listen for RPC connections", "r", tr_option::Arg::Required, "<ip addr>" },
    { 953,
      "global-seedratio",
    ...
    { 954,
      ...
      tr_option::Arg::None,
      nullptr },
    { 994, "sequential-download", "Enable sequential download by default", "seq", tr_option::Arg::None, nullptr },
    { 995, "no-sequential-download", "Disable sequential download by default", "SEQ", tr_option::Arg::None, nullptr },
    { 'x', "pid-file", "Enable PID file", "x", tr_option::Arg::Required, "<pid-file>" },
